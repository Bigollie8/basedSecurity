    ...
    local function lua()
        ...
        if banUser(informationVerification(args)) then
            ...
            --#region Put the lua in here 
                ...
                if #args == 1 then
                args = {"Admin","Debug", "1",43564536,"nil"}
                end
                ...
                --#region best aa thing that matrix made
                ...
                if get(menu.break_lagcomp_mode) == "Only when vulnerable" and freestanding.peeked == false and freestanding.vulnerable == false and self.last_vulnerable_time < globals_realtime() then
                    return
                end
