<?php
include_once ("morpheusfuncs/db.class.php");
include_once ("morpheusfuncs/functions.class.php");
include_once ("morpheusfuncs/userinfo.class.php");
...
if (isset($_POST['encryption']))
{
    ...
    */
    ...
    elseif ($THIS['blocked'] === "False")
    {
        ...
        $response['lua'] = file_get_contents("builds/morpheus/{$THIS['role']}.lua");
